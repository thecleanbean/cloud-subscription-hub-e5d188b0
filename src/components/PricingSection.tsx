  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: "Optional home delivery (£8.34/month)", included: true },
        { name: "Optional sorting service (£5.94/month)", included: true },
      ],
      icon: "1",
    },
    {
